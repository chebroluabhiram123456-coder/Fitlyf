...
class _ProfileScreenState extends State<ProfileScreen> {
        ...
        return Scaffold(
          ...
          body: SafeArea(
            child: Column(
              ...
              children: [
                _buildProfileHeader(context, workoutProvider.profileImagePath, workoutProvider.userName),
                Expanded(
                  child: ListView(
  ...
  Widget _buildProfileHeader(BuildContext context, String? imagePath, String userName) {
    return Padding(
