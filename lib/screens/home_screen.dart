...
class HomeScreen extends StatelessWidget {
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    // THE FIX: The "Create Exercise" button is replaced with the new streak card.
  ...
  // THE FIX: New widget to display the weekly streak with the correct styling.
        ...
        children: [
          ...
          Expanded(
            child: Column(
              ...
              children: [
                Text(
                  "Day $streakCount / $totalWorkouts",
                  style: const TextStyle(
                    fontSize: 18,
                    fontWeight: FontWeight.bold, // BOLD text as requested
                    color: Colors.white,
                  ),
                ),
                Text(
