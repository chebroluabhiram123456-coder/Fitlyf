...
import 'package:google_fonts/google_fonts.dart'; // Import for global font
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // First, we define the base dark theme data.
    ...
    return ChangeNotifierProvider(
      ...
      child: MaterialApp(
        title: 'FitLfy',
        // THE FIX: This is the correct, stable way to apply a global font theme.
        theme: base.copyWith(
          textTheme: GoogleFonts.poppinsTextTheme(base.textTheme),
          primaryColor: Colors.deepPurple,
          scaffoldBackgroundColor: Colors.transparent, // Important for our gradient
